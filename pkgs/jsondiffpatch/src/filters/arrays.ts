...
const arrayIndexOf = (array: any[], item: any) => array.indexOf(item)
...
export const diffFilter = function arraysDiffFilter(context: FilterContext) {
  ...
  let result: { _t: string; [index: number | string]: any } | undefined
...
export const reverseFilter = function arraysReverseFilter(
