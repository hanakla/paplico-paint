...
describe('DiffPatcher', () => {
    ...
    describe(groupName, () => {
      ...
      arrayForEach(group, example => {
        ...
        describe(name, () => {
          ...
          if (example.error) {
            it(`diff should fail with: ${example.error}`, () => {
              expect(() => {
  ...
  describe('using cloneDiffValues', () => {
    ...
    it("ensures deltas don't reference original objects", () => {
      const left = {
        oldProp: {
          value: 3
        }
