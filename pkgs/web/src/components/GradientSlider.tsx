  ...
  const bindDrag = useGesture(
    {
      onDrag: ({ event, ...e }) => {
        ...
        if (e.last && e.movement[1] < -20) {
          ...
          nextColorStops[index].position = PapWebMath.clamp(pos, 0, 1)
        }

        PapHelper.sortColorStopsByPositionAsc(nextColorStops)
...
export const addColorStopAt = (
  ...
  PapHelper.sortColorStopsByPositionAsc(colorStops)
  ...
  if (previous && next) {
    colorStops[idx].color = {
      r: PapWebMath.lerp(previous.color.r, next.color.r, 0.5),
      g: PapWebMath.lerp(previous.color.g, next.color.g, 0.5),
      b: PapWebMath.lerp(previous.color.b, next.color.b, 0.5),
      a: PapWebMath.lerp(previous.color.a, next.color.a, 0.5),
    }
