...
import { TreeView, TreeViewItemRow, TreeViewItem } from 'react-draggable-tree'
...
import { TreeRow } from './DesktopTreeView/TreeRow'
  ...
  return (
    ...
    >
      ...
      >
        {/* <TreeView
          rootItem={}
          handleDragStart={({ item, event }) => console.log(item)}
...
//   rows: readonly TreeViewItemRow<TreeViewItem>[]
//   index: number
//   item: TreeViewItem
//   depth: number
//   indentation: number
